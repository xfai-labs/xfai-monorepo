...
import favIcon from '@analytics/assets/favicon/favicon.ico';
import favIcon16 from '@analytics/assets/favicon/favicon-16x16.png';
import favIcon32 from '@analytics/assets/favicon/favicon-32x32.png';
import favIcon48 from '@analytics/assets/favicon/favicon-48x48.png';
import favIcon192 from '@analytics/assets/favicon/favicon-192x192.png';
import favIconSafariTab from '@analytics/assets/favicon/favicon-safari-tab.svg';
import socialCover from '@analytics/assets/social/social-cover.jpg';
